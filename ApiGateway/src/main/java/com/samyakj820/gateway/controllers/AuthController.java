package com.samyakj820.gateway.controllers;

import com.samyakj820.gateway.models.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RegisteredOAuth2AuthorizedClient("okta") OAuth2AuthorizedClient client,
        ...
        List<String> authorities = oidcUser.getAuthorities().stream().map(grantedAuthority -> { return  grantedAuthority.getAuthority(); }).collect(Collectors.toList());
